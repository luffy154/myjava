...
public class SecretTest {
    public static void main(String[] args) {
         ...
         */
        String token = "1744011818.DcP7Fu4gZEVDrn0b2zo/uWOgObVlpInc.7cbbde07f0771298";
        System.out.println(EncryptUtil.encrypt16("1750122380"+"1934534941979181056"));
        System.out.println(DESUtil.encrypt("15acd2dfz", "1934534941979181056"));
